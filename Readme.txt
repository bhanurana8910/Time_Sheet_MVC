...
Update-Database Identity -Context Time_Sheet_MVCIdentityContext



5. On the console execute the following command

Update-Database Time -Context Time_Sheet_MVCDatabaseContext



6. After migration is successful Run the project 

7 if you click on Employee/Department/TimeRecords  (Except Home) this will redirect you to ASP .net identity login page login from the following credentials

User : admin@timesheet.com
Password: 1qaz2wsX@
